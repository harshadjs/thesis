...
#+INCLUDE: ./http_over_xia.org :minlevel 1


* Main Questions
- Content Streaming in XIA
- Chunk-Aware vs Chunk-Agnostic Applications
- URL Format
- Are we doing HTTP or CID?
  - Metadata placement: in URL / in common metadata header / in
    object itself?
- Content Negotiation
...
#+INCLUDE: ./_oid_d0_manifest.org :minlevel 3
#+INCLUDE: ./_oid_d1_object_lib.org :minlevel 3
#+INCLUDE: ./_oid_d2_nwlayer.org :minlevel 3

* Content Negotiation
- Is content negotiation a very important feature?
  - Different content serving mechanisms: past and future.
  - Who all need (or can benefit from) content negotiation?
    - FTP
    - BitTorrent
    - Netflix / Video
    - Audio
    - HTTP
    - NDN
- If yes, can we push at network layer?
...
*** Issues in HTTP and XIA
- We are using HTTP, but we are using CIDs. What's this?
- Circular dependency of HTML
- Is HTML file a content object?
- Making chunk information available to network layer, good or bad?
- URL: CID://
- There could be different APP that publishes stuff: Why?!?!
*** SPDY protocol
- Tunnel for transferring HTTP requests / responses over the wire
- Gzip compression
- Send multiple resources over the same connection
** C3 Aditya Ganjam
- What is strawman?
- Global state? how global?
* Links
- Information Centrin Networking: Baseline scenarios: RFC 7476
- A Survey of Information-Centric Networking Research
  http://www.aueb.gr/users/vsiris/publications/p24_ICN_survey.pdf
